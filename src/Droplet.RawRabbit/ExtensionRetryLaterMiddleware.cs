...
using StageMarkerStatic = RawRabbit.Pipe.StageMarker;
...
namespace Droplet.RawRabbit
{
    ...
    /// 拓展重试中间件
    /// </summary>
    public class ExtensionRetryLaterMiddleware : StagedMiddleware
    {
        ...
        public override string StageMarker => StageMarkerStatic.HandlerInvoked;

        public ExtensionRetryLaterMiddleware(ITopologyProvider topology, INamingConventions conventions, IChannelFactory channelFactory, IRetryInformationHeaderUpdater headerUpdater, RetryLaterOptions options = null)
        {
